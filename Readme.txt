...
"Java Tutorial", which is freely
available on the web at https://www.javatpoint.com/java-tutorial
...
If you visit the "Java Tutorial" web site, you can find the files in a folder named "sources."  
The example programs are also available as a separate download.  The files are
